...
static int minix_readlink();
static int minix_follow_link();
...
static int minix_follow_link(dir,inode,flag,mode,res_inode)
...
static int minix_readlink(inode,buffer,buflen)
register struct inode * inode;
char * buffer;
int buflen;
{
