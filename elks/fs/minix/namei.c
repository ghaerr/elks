...
int minix_lookup(dir,name,len,result)
register struct inode * dir;
char * name;
int len;
...
int minix_create(dir,name,len,mode,result)
register struct inode * dir;
char * name;
int len;
int mode;
...
int minix_mknod(dir,name,len,mode,rdev)
register struct inode * dir;
char * name;
int len;
int mode;
...
int minix_mkdir(dir,name,len,mode)
register struct inode * dir;
char * name;
int len;
int mode;
...
int minix_symlink(dir,name,len,symname)
struct inode * dir;
char * name;
int len;
char * symname;
...
int minix_link(oldinode,dir,name,len)
