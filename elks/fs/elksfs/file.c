...
static int elksfs_file_write();
static int elksfs_file_read();
...
static int elksfs_file_read(inode,filp,buf,icount)
struct inode * inode;
...
#ifndef CONFIG_FS_RO
static int elksfs_file_write(inode,filp,buf,count)
