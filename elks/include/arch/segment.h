...
#define SEL_SETUP       0x28  /* setup.S data segment  (SEG_INITSEG, for setupb/setupw) */
#define SEL_OPTSEG      0x30  /* boot options area (SEG_OPTSEG, /bootopts at init) */
#define SEL_BIOSDATA    0x38  /* BIOS data area (SEG_BIOSDATA) */
#define SEL_VIDEO       0x40  /* CGA/EGA/VGA text video memory (SEG_VIDEO) */
#define SEL_TRACKBUF    0x48  /* directfd DMA track buffer (SEG_TRACK) */
#define SEL_DMABUF      0x50  /* ATA/CF DMA sector buffer (SEG_DMASEG) */
#define SEL_IDT         0x58  /* IDT table access at physical address 0:0 */
#define SEL_GDT         0x60  /* GDT table access (directly follows kernel data segment */
