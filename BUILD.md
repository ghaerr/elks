...
On Ubuntu these can ebe installed with: `sudo apt-get install texinfo libncurses5-dev libelf-dev ncompress`. Additionally gcc and other common tools are installed with: `sudo apt install build-essential`
