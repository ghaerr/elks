...
char *linespec(s, markptr)
	...
	REG MARK		*markptr;	/* where to store the mark's value */
{
	long		num;
	char	*t;
...
{
	REG char	*cmd;		/* start of a command */
	REG char	*end;		/* used to search for the end of cmd */
