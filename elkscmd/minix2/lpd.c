...
/* Place a file into the spool directory, either by copying it,
 * or by leaving a reference.
 */
 ...
 *	0 ignore,
 *	1 give up on controlling the printer,
 *	  assume user knows how printer works,
 *	2 print.
 */
char control[] = {
