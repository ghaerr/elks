...
static void
NewRendition(register old, register new)
{
    register i;
...
static void
RedisplayLine(os, oa, of, y, from, to)
    char *os, *oa, *of;
{
    if (curr->insert)
        InsertMode(0);
