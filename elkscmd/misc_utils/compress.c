...
#ifndef SACREDMEM
	/*
 	 * SACREDMEM is the amount of physical memory saved for others;
	 * compress will hog the rest.
 	 */
#	define SACREDMEM	0
#endif
...
#ifndef USERMEM
	/*
 	 * Set USERMEM to the maximum amount of physical user memory
	 * available in bytes. USERMEM is used to determine the maximum
	 * BITS that can be used for compression.
	 */
...
#  define SIGNED_COMPARE_SLOW	/* signed compare slower than unsigned	*/
#endif

#ifdef pdp11	 		/* PDP11: don't forget to compile with -i */
#  define BITS 12		/* max bits/code for 16-bit machine	*/
#  define NO_UCHAR		/* also if "unsigned char" functions as */
				/* signed char				*/
#endif /* pdp11 */
...
int		remove_ofname = 0;	/* Remove output file on a erro	*/
