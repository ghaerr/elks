...
int flags;
{
	...
	if (all || (c_cflag & CSIZE) != (TCTRL_DEF & CSIZE))
	{
		...
		switch (tmp)
		{
		case CS5: stty_output("cs5"); break;
		case CS6: stty_output("cs6"); break;
		case CS7: stty_output("cs7"); break;
		case CS8: stty_output("cs8"); break;
		default: stty_output("cs??"); break;
		}
	}
